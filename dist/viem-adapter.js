...
class ViemAdapter {
     ...
     */
    static fromWalletClient(walletClient) {
     ...
     */
    static fromPublicClient(publicClient) {
     ...
     */
    static fromViemAccount(account, transport, chain) {
        if (!account?.address) {
...
//# sourceMappingURL=viem-adapter.js.map