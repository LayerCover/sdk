 ...
 */
export const defaultTheme: BuyCoverTheme = {
    // Modal container
 ...
 * ```
 */
export function createTheme(overrides: Partial<BuyCoverTheme>): BuyCoverTheme {
    return {
        ...defaultTheme,
        ...overrides,
    };
 ...
 */
export const lightTheme: BuyCoverTheme = {
 ...
 */
export const eulerTheme: BuyCoverTheme = {
 ...
 */
export const compoundTheme: BuyCoverTheme = {
 ...
 */
export const carbonTheme: BuyCoverTheme = {
