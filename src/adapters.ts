...
export class EthersV5Adapter {
    ...
    static fromWeb3Provider(v5Provider: any): BrowserProvider {
        ...
        return new BrowserProvider(externalProvider);
    }
    ...
    static fromJsonRpcProvider(v5Provider: any): JsonRpcProvider {
        ...
        if (!url) throw new Error("Could not extract URL from v5 Provider");
     ...
     */
    static async fromSigner(v5Signer: any): Promise<JsonRpcSigner> {
